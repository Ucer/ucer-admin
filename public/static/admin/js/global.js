...
//公共js文件
    ...
    * */
    ...
    function updateSort(obj)
    {
        ...
        $.ajax({
            url:"/admin/Admin/updateSort/id/"+id+'/table/'+table+'/column/'+column+'/value/'+value,
    ...
    var delBtn = function(obj,a,urla){
        ...
        if(isEmpty('',id,'请选择要删除的数据')==false){return false;}
   ...
   var changeStatus = function(obj){
    ...
    function ajaxFormBtn(url,formId,layerClose){
        $.ajax({
            ...
            success: function(data) {
                if(data.code ==1){
                    layer.msg('操作成功',{icon:1,time:1000,shade: [0.8, '#393D49']},function(){
                        if(layerClose){
            ...
            error:function(){
                layer.msg('网络错误,请稍后再试',{icon:5,time:1000,shade: [0.8, '#393D49']});
                return false;
            }
        });
    }
